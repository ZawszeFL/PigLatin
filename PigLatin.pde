...
//postcondition: returns the pig latin equivalent of sWord
{
	...
	else if(findFirstVowel(sWord) != 0 && findFirstVowel(sWord) != 1&& findFirstVowel(sWord) != 2&& findFirstVowel(sWord) != 3&& findFirstVowel(sWord) != 4)
	{
		return sWord.substring(5)+sWord.substring(0,5)+"ay";
	}
